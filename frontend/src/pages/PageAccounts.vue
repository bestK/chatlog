...
<template>
    <div class="space-y-8">
        <section class="space-y-6">
            ...
            <div class="grid gap-4 [grid-template-columns:repeat(auto-fit,minmax(320px,1fr))] md:gap-6">
                <div
                    v-if="instances.length === 0"
                    class="col-span-full rounded-2xl border border-dashed border-border/40 bg-muted/5 py-12 text-center"
                >
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex items-center gap-4">
                                <div class="relative">
                                    ...
                                    <div
                                        v-else
                                        class="flex size-14 items-center justify-center rounded-2xl border border-border/20 bg-muted/30 text-lg font-bold"
                                    >
                                ...
                                <div class="space-y-1">
                                    ...
                                    <div
                                        class="flex flex-wrap items-center gap-x-2 gap-y-1 font-mono text-[10px] text-muted-foreground"
                                    >
            ...
            <Card class="border-border/40 bg-card/40 shadow-none">
                        ...
                        <div class="flex flex-col gap-4 p-5 lg:flex-row lg:items-center lg:justify-between">
                            <div class="space-y-1">
                                ...
                                <CardDescription class="text-xs"
                                    >检索当前账号下的联系人、群聊及公众号数据</CardDescription
                                >
                            </div>
                            <div class="flex flex-wrap items-center gap-2">
                                <Badge
                                    variant="secondary"
                                    class="h-6 rounded-md bg-muted/50 font-mono text-[10px] font-medium text-muted-foreground uppercase"
                                >
                                ...
                                <Badge
                                    v-if="hasKeyword"
                                    variant="secondary"
                                    class="h-6 gap-2 rounded-md bg-primary/12 font-mono text-[10px] uppercase text-primary"
                                >
                        ...
                        <div class="flex flex-wrap items-center gap-3 p-5">
                            <div class="relative w-full min-w-[200px] flex-1 basis-[260px]">
                                <Input
                                    ...
                                    class="h-10 pl-4 pr-10 font-mono text-sm"
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <Button
                                    ...
                                    class="h-10 w-10 shrink-0 border border-border/40"
                            ...
                            <div class="flex items-center gap-2">
                                <Button
                                    variant="outline"
                                    size="sm"
                                    class="h-10 px-4 text-xs font-bold uppercase transition-all"
                                ...
                                <Button
                                    size="sm"
                                    class="h-10 px-4 text-xs font-bold uppercase transition-all shadow-md shadow-primary/10"
                ...
                <CardContent class="relative p-6">
                    <div
                        ...
                        class="pointer-events-none absolute inset-x-0 top-0 z-50 flex justify-center"
                    >
                        <div
                            class="mt-4 animate-pulse rounded-full bg-primary/90 px-4 py-1.5 text-[10px] font-bold uppercase tracking-widest text-primary-foreground shadow-lg"
                        >
                            同步中 (Syncing...)
                        </div>
                    </div>
                    ...
                    <div v-if="contactsLoading && !hasContacts" class="py-20 text-center">
                        <div
                            class="mx-auto flex size-12 animate-spin items-center justify-center rounded-full border-2 border-primary border-t-transparent opacity-40"
                        ></div>
                    ...
                    <div
                        ...
                        :class="contactsLoading ? 'opacity-40 animate-pulse transition-opacity' : ''"
                    >
                        <Card
                        ...
                        >
                            <CardContent class="p-4">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div
                                        v-else
                                        class="flex size-10 items-center justify-center rounded-xl border border-border/20 bg-muted/40 text-sm font-bold opacity-60"
                                    >
                                        {{ getContactAvatarFallback(contact) }}
                                    </div>

                                    <div class="min-w-0 flex-1 space-y-0.5">
                                        <div class="truncate text-sm font-bold tracking-tight text-foreground/90">
                                ...
                                <div class="mt-4 flex flex-wrap items-center gap-2">
                                    <Badge
                                        variant="outline"
                                        class="h-5 border-border/40 bg-muted/20 px-1.5 font-mono text-[9px] font-normal text-muted-foreground uppercase"
                                    >
                                    ...
                                    <Badge
                                        ...
                                        variant="outline"
                                        class="h-5 border-primary/20 bg-primary/5 px-1.5 font-mono text-[9px] font-bold text-primary uppercase"
                                    >
                                        ROOM
                                    </Badge>
                                </div>
