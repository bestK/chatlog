...
<template>
    <div class="flex h-full flex-col space-y-2 overflow-hidden">
        <div class="flex items-center gap-3 border-b border-border/40 pb-2 shrink-0">
            <div
                class="flex size-6 items-center justify-center rounded bg-primary/10 text-[8px] font-bold text-primary"
            >
                01
            </div>
        ...
        <Card class="flex flex-1 flex-col min-h-0 overflow-hidden border-border/40 bg-card/40 shadow-none">
            <div class="shrink-0 border-b border-border/40 bg-muted/10 px-3 py-1.5 flex flex-col gap-2">
                <div class="flex flex-wrap items-center justify-between gap-2">
                    <div class="flex items-center gap-3">
                        ...
                        <Badge
                            ...
                            class="h-4 px-1.5 font-mono text-[8px] font-bold uppercase tracking-wider"
                        >
                    ...
                    <div class="flex items-center gap-1.5">
                        <Button
                            variant="ghost"
                            size="sm"
                            class="h-6 px-2 text-[9px] font-bold uppercase tracking-widest text-muted-foreground hover:text-foreground"
                        ...
                        >
                            <svg
                                :class="['size-2.5', loading ? 'animate-spin' : '']"
                ...
                <div class="flex flex-wrap items-center gap-x-4 gap-y-1.5">
                    <div class="flex flex-1 basis-[260px] items-center gap-2 min-w-0">
                        <span class="text-[8px] font-bold uppercase tracking-widest text-muted-foreground/50 shrink-0"
                            >PATH</span
                        >
                        <div class="group relative flex flex-1 items-center min-w-0">
                            <div
                                class="flex-1 overflow-hidden truncate rounded border border-border/20 bg-muted/30 px-2 py-0.5 font-mono text-[9px] text-foreground/50"
                            >
                                {{ logPath || 'Loading...' }}
                            </div>
                            <button
                                class="ml-1 opacity-0 group-hover:opacity-100 transition-opacity"
                                @click="copyText(logPath, '路径')"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="10"
                    ...
                    <div class="flex flex-1 basis-[260px] items-center gap-2 min-w-0">
                        ...
                        <div class="relative flex-1">
                            <svg
                                class="absolute left-2 top-1/2 -translate-y-1/2 size-2.5 text-muted-foreground/40"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                                fill="none"
                                stroke="currentColor"
            ...
            <div class="flex flex-1 min-h-0 p-2">
                <div
                    class="relative h-full overflow-hidden rounded-lg border border-border/40 bg-[#080808] shadow-2xl flex flex-col"
                >
                    <div
                        class="shrink-0 flex items-center justify-between bg-black/40 px-3 py-1 backdrop-blur-md border-b border-white/5"
                    >
                        <div class="flex items-center gap-1.5">
                        ...
                        <div class="text-[7px] font-bold uppercase tracking-[0.4em] text-zinc-700">
                            Live Console Stream
                        </div>
                    </div>
                    ...
                    <pre
                        ...
                        v-html="
                            filteredHtml ||
                            '<div class=\'flex h-full items-center justify-center opacity-10 uppercase tracking-[0.3em] text-[10px]\'>No Data</div>'
                        "
                    />
                </div>
            </div>
